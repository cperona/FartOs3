...
public class C8DialogFragment extends DialogFragment implements SelectListenerJugador {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.casella_ultima_dialog_fragment, null);

        Bundle bundle = getArguments();
        jugadors = (List<Jugador>) bundle.getSerializable("jugadors");
        user = (Jugador) bundle.getSerializable("user");
        btnRv = view.findViewById(R.id.buttonsRecyclerView);
    ...
    public void init(){
        ...
        btnRv.setAdapter(jugadorButtonAdapter);
    }
    @Override
